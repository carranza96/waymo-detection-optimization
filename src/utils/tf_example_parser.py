...
class BoundingBoxParser(data_parser.DataToNumpyParser):
    ...
    def __init__(self, xmin_field_name, ymin_field_name, xmax_field_name, ymax_field_name):
        ...
        # self.width_field_name = width_field_name
        # self.height_field_name = height_field_name
        # self.to_absolute_coordinates = to_absolute_coordinates
...
class TfExampleDetectionAndGTParser(data_parser.DataToNumpyParser):
    ...
    def __init__(self):
        self.items_to_handlers = {
            ...
            fields.TfExampleFields.width: Int64Parser(fields.TfExampleFields.width),
            fields.TfExampleFields.height: Int64Parser(fields.TfExampleFields.height),
